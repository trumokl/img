...
<footer id="rin-footer">
    <div>©2020-2021 Blue. | Made with love by Blue. | BG: <a href="https://cdn.jsdelivr.net/gh/trumokl/img@main/">
	   <img class="badge" src="https://data.jsdelivr.com/v1/package/gh/trumokl/img/badge"></a>
		</div>
</footer>
...
function uploadimg(file){
      ...
      var picurl="https://cdn.jsdelivr.net/gh/trumokl/img@main/"+nameofimg;
    var settings = {
    "url": "https://api.github.com/repos/trumokl/img/contents/"+nameofimg,
    "method": "PUT",
    "timeout": 0,
    "headers": {
        "Authorization": "Bearer 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",
